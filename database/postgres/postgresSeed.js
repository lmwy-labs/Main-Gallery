...
const foodNames = foodWords.replace(/,/g, '. ').split('. ');
...
// COPY images(i_id,url,name,picturedate,source,photographer,restaurant_id) FROM '/Users/jasonchen/Desktop/HR-projects/SDC/ot-main-gallery/database/postgres/seedDatabase.csv' CSV HEADER DELIMITER ',';
